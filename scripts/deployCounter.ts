...
export async function run() {
  ...
  const mnemonic = "act strike detect tribe conduct youth bargain coin obey member range flower extra sugar taste final design bulk float disorder fringe split story input"; // your 24 secret words (replace ... with the rest of the words)
